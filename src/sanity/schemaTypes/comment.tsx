...
// Custom SVG icon to avoid @sanity/icons resolution issues
const ChatIcon = () => (
...
// Comment document type — submitted via server action, moderated via the Studio
// References the post it belongs to and stores the Clerk user's name + image URL
